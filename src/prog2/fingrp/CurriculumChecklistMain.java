...
/*
 * Notes
 * run() method contains the merging of the GUI and Backend (Horrendous af)
            ...
            try{
                ...
                if(result == JOptionPane.OK_OPTION) {
                    record.editCourse(editFields[0].getText(), new Course.CourseBuilder().code(editFields[0].getText())
                            ...
                            .term(Integer.parseInt(editFields[5].getText())).status((Course.STATUS) gui.getCourseStatus().getSelectedItem())
                            .electiveStatus(gui.getIsElective().isSelected()));
                    updateTable();
                }
